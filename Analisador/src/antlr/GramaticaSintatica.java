...
public class GramaticaSintatica extends Parser {
	...
	public static final int
		...
		FOR=11, WHILE=12, AP=13, FP=14, ACH=15, FCH=16, DELIMITADOR=17, SEPARADOR=18, 
		RETORNO=19, INPUT=20, OUTPUT=21, MODACESSO=22, TEXTO=23, NUM=24, COMENT=25, 
		WS=26, ErrorChar=27;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"THEN", "FOR", "WHILE", "AP", "FP", "ACH", "FCH", "DELIMITADOR", "SEPARADOR", 
			"RETORNO", "INPUT", "OUTPUT", "MODACESSO", "TEXTO", "NUM", "COMENT", 
			"WS", "ErrorChar"
		};
	}
