...
public class GramaticaSintatica extends Parser {
	...
	public static class QualquerCoisaContext extends ParserRuleContext {
		...
		public QualquerCoisaContext() { }
		public void copyFrom(QualquerCoisaContext ctx) {
			super.copyFrom(ctx);
		}
	}
	public static class BlocoCodigoContext extends QualquerCoisaContext {
		public List<DeclaracaoContext> declaracao() {
			return getRuleContexts(DeclaracaoContext.class);
		}
		public DeclaracaoContext declaracao(int i) {
		...
		public BlocoCodigoContext(QualquerCoisaContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof GramaticaSintaticaListener ) ((GramaticaSintaticaListener)listener).enterBlocoCodigo(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof GramaticaSintaticaListener ) ((GramaticaSintaticaListener)listener).exitBlocoCodigo(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof GramaticaSintaticaVisitor ) return ((GramaticaSintaticaVisitor<? extends T>)visitor).visitBlocoCodigo(this);
			else return visitor.visitChildren(this);
		}
	}
